...
#define CONFIG_ASYNC_TCP_STACK (12 * 1024)
...
#define SSL_HANDSHAKE_TIMEOUT 3000 // timeout to complete SSL handshake
...
{
public:
    AsyncSSLClient(tcp_pcb *pcb = nullptr);
    ...
    bool is_tls_read_performs() { return _tls_read_performs == Tls_Read_st::reading; }
    ...
    static void _s_tcp_cleared(void *arg);
    static void _s_event_close(void *arg);
...
protected:
    ...
    int8_t _closed_slot;
    Tls_Read_st _tls_read_performs;
    //bool _emergeClose;
