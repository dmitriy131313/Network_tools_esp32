...
#define SSL_FINGERPRINT_NULL NULL
    ...
    void* _reconnect_timer;
    TaskHandle_t _reconnect_task_h;
    // TaskHandle_t _heartbeat_task_h;
    QueueHandle_t _reconnect_q;
    uint8_t _request_tim_action;
    ...
    void reconnectTimStart();
    void reconnectTimStop();
